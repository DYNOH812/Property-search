      ...
      const fetchUserProperties= async (userId) =>{
        if(!userId){
          ...
          try {
            ...
            if(res.status === 200){ const data = await res.json(); setProperties(data)}
          } catch (error) {
            console.log(error);
          } finally {
            setLoading(false);
            ...
            <div className="md:w-3/4 md:pl-4">
              ...
              {loading ? <p>Loading...</p> : (properties.map((property)=>(
                ...
                <div className="mt-2">
                  ...
                  <p className="text-gray-600">Address:{property.location.street} {property.location.city} {property.location.county}</p>
                </div>
                <div className="mt-2">
